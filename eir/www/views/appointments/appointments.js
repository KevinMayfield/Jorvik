angular.module('App')
.controller('AppointmentsController', function ($scope, AppService, $http, $ionicLoading) {
  
  $ionicLoading.show();
  $http({
        method : 'GET',
        url : AppService.baseURL + '/fhir/Patient?identifier=http://fhir.nhs.net/Id/nhs-number|'+AppService.NHSNumber,
        headers: {
